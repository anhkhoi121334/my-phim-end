      ...
      <div className="relative aspect-[2/3] rounded-lg overflow-hidden bg-white shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3">
          ...
          <div className="flex items-center gap-2">
            <span className={`${getBadgeColor()} text-white px-2 py-0.5 rounded text-xs font-medium shadow-sm`}>
              {movie.episode_current}
            </span>
            <span className="text-gray-100 text-xs font-medium">{getQualityBadge()}</span>
          </div>
        </div>
      </div>
    </Link>
